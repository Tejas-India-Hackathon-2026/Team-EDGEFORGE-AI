...
|---|---|---|
| **Admin** | Netlify Function verifies salted hashes and issues a signed HttpOnly session cookie | Unlocks Admin Dashboard (photo thumbnails, 1-click "Approve & Verify" with auto-verified seal, inquiries log) |
